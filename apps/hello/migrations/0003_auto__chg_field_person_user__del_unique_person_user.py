...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'hello_person', ['user_id'])


        # Changing field 'Person.user'
        db.alter_column(u'hello_person', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Person.user'
        db.alter_column(u'hello_person', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Person', fields ['user']
        db.create_unique(u'hello_person', ['user_id'])
